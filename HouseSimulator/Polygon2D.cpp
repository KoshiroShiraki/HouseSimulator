...
Polygon2D::Polygon2D() {
	...
	m_worldVertices[0].x = m_localVertices[0].x = -50.0f; m_worldVertices[0].y = m_localVertices[0].y = 50.0f;
	m_worldVertices[1].x = m_localVertices[1].x = 50.0f; m_worldVertices[1].y = m_localVertices[1].y = 50.0f;
	m_worldVertices[2].x = m_localVertices[2].x = 50.0f; m_worldVertices[2].y = m_localVertices[2].y = -50.0f;
...
void Polygon2D::initParam() {
	m_centerX = m_centerY = 0.0;
	m_sizeX = m_sizeY = 1.0;
	m_rotation = 0;
}

void Polygon2D::move(double dx, double dy) {
	m_centerX += dx;
	m_centerY += dy;
